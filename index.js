...
MongoClient.connect(process.env.DATA_BASE_CONN_URI, {
  ...
  .then(async (client) => {
    ...
    await inventoryDataAccessObject.injectDiscount(client);
    ...
    await inventoryDataAccessObject.injectVariable(client);
    ...
    await inventoryDataAccessObject.injectStockTransfer(client);
    ...
    await inventoryDataAccessObject.injectAdjustment(client);
    await inventoryDataAccessObject.injectStockReconciliation(client);
